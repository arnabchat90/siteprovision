...
export default class MainForm extends React.Component<IMainProps, IMainState> {
  constructor(props) {
    ...
    this._getPeoplePickerItemsExecutive = this._getPeoplePickerItemsExecutive.bind(
      this
    );
  ...
  clearCallback() {
    ...
    tempFormData.siteName = "";
    tempFormData.siteDescription = "";
    tempFormData.groupEmailAddress = "";
    this.setState({
      formData: tempFormData
    });
    var resetForm: HTMLFormElement;
    resetForm = document.getElementById("mainForm") as HTMLFormElement;
      ...
      <form id="mainForm">
        <div className={styles.mainForm}>
          <div className={styles.container}>
            {this.props.showCurrentStatus == true ? (
            ...
            <div className={styles.row}>
              <div className={styles.column}>
                ...
                <TextField
                  id="siteName"
                  value={this.state.formData.siteName}
                  onChanged={newValue => {
                    this._handleOnChange(newValue, "siteName");
                  }}
                />
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.column}>
                ...
                <TextField
                  ...
                  rows={4}
                  id="siteDescription"
                  value={this.state.formData.siteDescription}
                  onChanged={newValue => {
                    this._handleOnChange(newValue, "siteDescription");
                  }}
                />
              </div>
            </div>
            <div style={{ display: "none" }} className={styles.row}>
              <div className={styles.column}>
                <Label
                  style={{ fontWeight: FontWeights.semibold }}
                  htmlFor="groupEmailAddress"
                >
                  Group Email Address
                </Label>
                <TextField
                  id="groupEmailAddress"
                  value={this.state.formData.groupEmailAddress}
                  onChanged={newValue => {
                    this._handleOnChange(newValue, "groupEmailAddress");
                  }}
                />
              </div>
            </div>
            ...
            <div className={styles.row}>
              <div className={styles.column}>
                <Dropdown
                  ...
                  onChanged={newValue => {
                    this._handleOnChange(newValue, "practice");
                  }}
                />
              </div>
            </div>
              ...
              <div className={styles.column}>
                <Dropdown
                  ...
                  options={[
                    {
                      key: "Private",
                      text: "Private - Only Members Can access this site",
                      title: "Private - Only Members Can access this site"
                    },
                    {
                      key: "Public",
                      text: "Public - Anyone Can Access This Site"
                    }
                  ]}
                  onFocus={this._log("onFocus called")}
                  onBlur={this._log("onBlur called")}
                  onChanged={newValue => {
                    this._handleOnChange(newValue, "privacyOptions");
                  }}
                />
              </div>
            </div>
            ...
            <div className={styles.row}>
              <div className={styles.column}>
                <PrimaryButton
                  disabled={this.props.finishDisabled}
                  data-automation-id="createSiteCollection"
                  text="Finish"
                  onClick={this.props.createSiteCollection.bind(
                    this,
                    this.state.formData,
                    this.clearCallback
                  )}
